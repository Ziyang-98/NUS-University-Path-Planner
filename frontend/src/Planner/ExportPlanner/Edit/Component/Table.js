...
const PlannerTable = ({ moduleList, handleEdited, handleModuleListChange }) => {
  const [open, setOpen] = React.useState(false);
      ...
      <div className={classes.updateButton}>
        ...
        >
          <DialogTitle id="alert-user-title">
            {"Overwrite the current table in your guide?"}
          </DialogTitle>
          <DialogContent>
            <DialogContentText id="alert-user-description">
              Updating the planner would overwrite your guide with your current
              planner. Press update to proceed.
            </DialogContentText>
          </DialogContent>
          <DialogActions>
